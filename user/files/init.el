...
(use-package org
  ...
  (setq org-agenda-category-icon-alist
        `(("TASK" ,(list (all-the-icons-faicon "check-square-o")) nil nil :ascent center)
          ("MEETING" ,(list (all-the-icons-faicon "comments-o")) nil nil :ascent center)
          ("CHORES",(list (all-the-icons-faicon "cog")) nil nil :ascent center)))
...
(defun vterm/rename-buffer ()
  (interactive)
  (unless (string-match-p "aider" (buffer-name))
	(let ((n 0)
          (new-name nil))
		  ...
		  (cond
		   ((string= provider "api.openai.com")
			(setq gptel-backend (gptel-make-openai "ChatGPT"
								  :key apikey
								  :stream t
								  :models '(gpt-5.3-chat-latest o3-deep-research))
