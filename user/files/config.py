...
color_green_d = "#0CCA4A"
color_green_l = "#95C623"

color_yellow_d = "#FCAB10"
color_yellow_l = "#FC996E"
...
color_magenta_d = "#DF57BC"
color_magenta_l = "#DA4FCD"

color_black_d = "#000000"
color_black_l = "#464228"

color_white_d = "#FFFFFF"
color_white_l = "#FCFBF9"
...
c.colors.completion.fg = color_fg_d

# Background color of the completion widget for odd rows.
c.colors.completion.odd.bg = color_white_l

# Background color of the completion widget for even rows.
c.colors.completion.even.bg = color_white_d

# Foreground color of completion widget category headers.
c.colors.completion.category.fg = color_white_l

# Background color of the completion widget category headers.
c.colors.completion.category.bg = color_fg_l

# Top border color of the completion widget category headers.
c.colors.completion.category.border.top = color_fg_l

# Bottom border color of the completion widget category headers.
c.colors.completion.category.border.bottom = color_fg_l

# Foreground color of the selected completion item.
c.colors.completion.item.selected.fg = color_white_d

# Background color of the selected completion item.
c.colors.completion.item.selected.bg = color_blue_d

# Top border color of the selected completion item.
c.colors.completion.item.selected.border.top = color_blue_d

# Bottom border color of the selected completion item.
c.colors.completion.item.selected.border.bottom = color_blue_d

# Foreground color of the matched text in the selected completion item.
c.colors.completion.item.selected.match.fg = color_green_d

# Foreground color of the matched text in the completion.
c.colors.completion.match.fg = color_green_d

# Color of the scrollbar handle in the completion view.
c.colors.completion.scrollbar.fg = color_fg_l

# Color of the scrollbar in the completion view.
c.colors.completion.scrollbar.bg = color_white_l

# Background color of disabled items in the context menu.
c.colors.contextmenu.disabled.bg = color_white_d

# Foreground color of disabled items in the context menu.
c.colors.contextmenu.disabled.fg = color_fg_l

# Background color of the context menu. If set to null, the Qt default is used.
c.colors.contextmenu.menu.bg = color_bg

# Foreground color of the context menu. If set to null, the Qt default is used.
c.colors.contextmenu.menu.fg =  color_fg_d

# Background color of the context menu’s selected item. If set to null, the Qt default is used.
c.colors.contextmenu.selected.bg = color_blue_d

#Foreground color of the context menu’s selected item. If set to null, the Qt default is used.
c.colors.contextmenu.selected.fg = color_white_d

# Background color for the download bar.
c.colors.downloads.bar.bg = color_fg_l

# Color gradient start for download text.
c.colors.downloads.start.fg = color_white_l

# Color gradient start for download backgrounds.
c.colors.downloads.start.bg = color_blue_l

# Color gradient end for download text.
c.colors.downloads.stop.fg = color_white_d

# Color gradient stop for download backgrounds.
c.colors.downloads.stop.bg = color_green_d

# Foreground color for downloads with errors.
c.colors.downloads.error.fg = color_red_l

# Font color for hints.
c.colors.hints.fg = color_black_d

# Background color for hints. Note that you can use a `rgba(...)` value
# for transparency.
c.colors.hints.bg = color_yellow_d

# Font color for the matched part of hints.
c.colors.hints.match.fg = color_green_d

# Text color for the keyhint widget.
c.colors.keyhint.fg = color_fg_d

# Highlight color for keys to complete the current keychain.
c.colors.keyhint.suffix.fg = color_blue_d

# Background color of the keyhint widget.
c.colors.keyhint.bg = color_yellow_d

# Foreground color of an error message.
c.colors.messages.error.fg = color_red_d

# Background color of an error message.
c.colors.messages.error.bg = color_bg

# Border color of an error message.
c.colors.messages.error.border = color_red_d

# Foreground color of a warning message.
c.colors.messages.warning.fg = color_yellow_d

# Background color of a warning message.
c.colors.messages.warning.bg = color_bg

# Border color of a warning message.
c.colors.messages.warning.border = color_yellow_d

# Foreground color of an info message.
c.colors.messages.info.fg = color_fg_d

# Background color of an info message.
c.colors.messages.info.bg = color_bg

# Border color of an info message.
c.colors.messages.info.border = color_fg_d

# Foreground color for prompts.
c.colors.prompts.fg = color_fg_d

# Border used around UI elements in prompts.
c.colors.prompts.border = color_fg_d

# Background color for prompts.
c.colors.prompts.bg = color_bg

# Background color for the selected item in filename prompts.
c.colors.prompts.selected.bg = color_green_l

# Foreground color for the selected item in filename prompts.
c.colors.prompts.selected.fg = color_fg_d

# Foreground color of the statusbar.
c.colors.statusbar.normal.fg = color_white_d

# Background color of the statusbar.
c.colors.statusbar.normal.bg = color_fg_l

# Foreground color of the statusbar in insert mode.
c.colors.statusbar.insert.fg = color_white_d

# Background color of the statusbar in insert mode.
c.colors.statusbar.insert.bg = color_yellow_d

# Foreground color of the statusbar in passthrough mode.
c.colors.statusbar.passthrough.fg = color_white_d

# Background color of the statusbar in passthrough mode.
c.colors.statusbar.passthrough.bg = color_green_d

# Foreground color of the statusbar in private browsing mode.
c.colors.statusbar.private.fg = color_white_d

# Background color of the statusbar in private browsing mode.
c.colors.statusbar.private.bg = color_black_l

# Foreground color of the statusbar in command mode.
c.colors.statusbar.command.fg = color_white_d

# Background color of the statusbar in command mode.
c.colors.statusbar.command.bg = color_blue_d

# Foreground color of the statusbar in private browsing + command mode.
c.colors.statusbar.command.private.fg = color_white_d

# Background color of the statusbar in private browsing + command mode.
c.colors.statusbar.command.private.bg = color_blue_d

# Foreground color of the statusbar in caret mode.
c.colors.statusbar.caret.fg = color_white_d

# Background color of the statusbar in caret mode.
c.colors.statusbar.caret.bg = color_magenta_d

# Foreground color of the statusbar in caret mode with a selection.
c.colors.statusbar.caret.selection.fg = color_white_d

# Background color of the statusbar in caret mode with a selection.
c.colors.statusbar.caret.selection.bg = color_magenta_l

# Background color of the progress bar.
c.colors.statusbar.progress.bg = color_green_l

# Default foreground color of the URL in the statusbar.
c.colors.statusbar.url.fg = color_white_d

# Foreground color of the URL in the statusbar on error.
c.colors.statusbar.url.error.fg = color_red_d

# Foreground color of the URL in the statusbar for hovered links.
c.colors.statusbar.url.hover.fg = color_cyan_l

# Foreground color of the URL in the statusbar on successful load
# (http).
c.colors.statusbar.url.success.http.fg = color_fg_d

# Foreground color of the URL in the statusbar on successful load
# (https).
c.colors.statusbar.url.success.https.fg = color_green_d

# Foreground color of the URL in the statusbar when there's a warning.
c.colors.statusbar.url.warn.fg = color_red_d

# Background color of the tab bar.
c.colors.tabs.bar.bg = color_fg_l

# Color gradient start for the tab indicator.
c.colors.tabs.indicator.start = color_fg_l

# Color gradient end for the tab indicator.
c.colors.tabs.indicator.stop = color_fg_d

# Color for the tab indicator on errors.
c.colors.tabs.indicator.error = color_red_d

# Foreground color of unselected odd tabs.
c.colors.tabs.odd.fg = color_white_l

# Background color of unselected odd tabs.
c.colors.tabs.odd.bg = color_fg_l

# Foreground color of unselected even tabs.
c.colors.tabs.even.fg = color_white_l

# Background color of unselected even tabs.
c.colors.tabs.even.bg = color_fg_l

# Background color of pinned unselected even tabs.
c.colors.tabs.pinned.even.bg = color_fg_l

# Foreground color of pinned unselected even tabs.
c.colors.tabs.pinned.even.fg = color_white_l

# Background color of pinned unselected odd tabs.
c.colors.tabs.pinned.odd.bg = color_fg_l

# Foreground color of pinned unselected odd tabs.
c.colors.tabs.pinned.odd.fg = color_white_l

# Background color of pinned selected even tabs.
c.colors.tabs.pinned.selected.even.bg = color_fg_d

# Foreground color of pinned selected even tabs.
c.colors.tabs.pinned.selected.even.fg = color_white_d

# Background color of pinned selected odd tabs.
c.colors.tabs.pinned.selected.odd.bg = color_fg_d

# Foreground color of pinned selected odd tabs.
c.colors.tabs.pinned.selected.odd.fg = color_white_d

# Foreground color of selected odd tabs.
c.colors.tabs.selected.odd.fg = color_white_d

# Background color of selected odd tabs.
c.colors.tabs.selected.odd.bg = color_fg_d

# Foreground color of selected even tabs.
c.colors.tabs.selected.even.fg = color_white_d

# Background color of selected even tabs.
c.colors.tabs.selected.even.bg = color_fg_d
...
## unlimited
## Type: Int
c.completion.web_history.max_items = 8
...
## Type: FormatString
c.content.headers.user_agent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Safari/537.36 Edg/123.0.2420.81'
...
## Type: String
c.hints.border = '1px solid #37474F'
...
## Type: Padding
c.tabs.indicator.padding = {'top': 4, 'bottom': 4, 'left': 2, 'right': 4}
